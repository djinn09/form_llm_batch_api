"""Pydantic models for OpenAI Batch API and application logic."""
...
class BatchRequest(BaseModel):
    ...
    url: str = Field(
        "/v1/chat/completions",
        description="The API endpoint for the request.",
    )
...
class ComparisonResult(BaseModel):
    ...
    status: str = Field(
        ...,
        description=("The outcome of the processing, e.g., 'Match Found', 'Mismatch', 'Error'."),
    )
